...
function checklog()
{
    ...
    if (isset($_SESSION["admin"]) && $_SESSION["admin"] === true) {
        echo "<li>
                    ...
                    <ul>
                        <li><a href=\"src/upload.php\" class=\"nav2link\">UPLOAD</a></li>
                        <li><a href=\"src/MyPictures.php\" class=\"nav2link\">MY PHOTO</a></li>
                        <li><a href=\"src/favorpage.php\" class=\"nav2link\">MY FAVORITE</a></li>
                        <li><a href=\"src/index.php\" class=\"nav2link\">SIGN IN</a></li>
                    </ul>
                </li>";
    }
    else{
